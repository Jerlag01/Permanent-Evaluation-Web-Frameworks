...
export class DemolService {

  constructor(private http: HttpClient) { }

  public movieid: string;

  getAnimeCharacter(movieid, pagenumber: number) {
    return this.http.get<IAnimeMovies>(`https://kitsu.io/api/edge/anime?filter[text]=${movieid}&page[limit]=5&page[offset]=${pagenumber}]`);
  }
}
